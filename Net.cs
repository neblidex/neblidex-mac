...
namespace NebliDex_Linux
{
    ...
    public partial class App
    {
        ...
        public static void CheckCNBlockHelperServerSync()
        {
            ...
            //Put this herein case Critical Node disconnects from BlockHelperdueto connection issue
        ...
        public static bool TakerReceiveValidatorInfo(DexConnection con, JObject js)
        {
            ...
            try
            {
                ...
                if (ConnectSync(client, address, critical_node_port, 30))
                {
                    ...
                    //We must add the block inclusion timeof the maker's contract in case maker wants to refund
                    long maker_inclusion_time = GetBlockInclusionTime(makerwallet, 0);
        ...
        public static bool MakerReceiveValidatorInfo(DexConnection con, JObject js)
        {
            ...
            try
            {
                ...
                if (ConnectSync(client, address, critical_node_port, 30))
                {
                    ...
                    //Calculate our inclusion time and subtract from taker unlock time
        ...
        public static void TakerConfirmTrade(DexConnection con, JObject js)
        {
            ...
            long taker_unlock_time = Convert.ToInt64(GetMyTransactionData("atomic_unlock_time", reqtime, order_nonce)); //First get taker unlock time
            string secret_hash = GetMyTransactionData("atomic_secret_hash", reqtime, order_nonce);
