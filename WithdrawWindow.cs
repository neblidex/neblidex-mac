...
namespace NebliDex_Linux
{
    public partial class WithdrawWindow : Gtk.Window
    {
                ...
                base(Gtk.WindowType.Toplevel)
        {
            ...
            withdraw_label.Markup = "<span font='17'>Withdraw</span>";
            ...
            Balance_Amount.Markup = "<span font='17'><b>"+String.Format(CultureInfo.InvariantCulture, "{0:0.########}", balance) + " " + App.WalletList[0].Coin + "</b></span>";
            this.Show();
        }
        ...
        private void Change_Coin(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < App.WalletList.Count; i++)
            {
                if (App.WalletList[i].Coin == which_coin)
                {
                    ...
                    {
						Balance_Amount.Markup = "<span font='17'><b>"+String.Format(CultureInfo.InvariantCulture, "{0:0.########}", balance) + " " + App.WalletList[i].Coin+"</b></span>";
                    }
                    break;
                }
            }
