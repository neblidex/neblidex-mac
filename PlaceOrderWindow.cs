...
namespace NebliDex_Linux
{
    public partial class PlaceOrderWindow : Gtk.Window
    {
                ...
                base(Gtk.WindowType.Toplevel)
        {
			...
			order_label.Markup = "<span font='17'>Create Order</span>";
            ...
            {
                //Buy Order
				Order_Header.Markup = "<span font='21'><b>Buy " + trade_symbol+"</b></span>";
				My_Balance.Markup = "<span font='15'><b>"+String.Format(CultureInfo.InvariantCulture, "{0:0.########}", balance) + " " + base_symbol+ "</b></span>";
				Price_Header.Markup= "<span font='14'>Price (" + base_symbol + "):</span>";
				Amount_Header.Markup = "<span font='14'>Amount (" + trade_symbol + "):</span>";
				Min_Amount_Header.Markup = "<span font='14'>Minimum Match (" + trade_symbol + "):</span>";
				Total_Header.Markup = "<span font='14'>Total Cost (" + base_symbol + "):</span>";
            }
            else
            {
                //Sell Order
				Order_Header.Markup = "<span font='21'><b>Sell " + trade_symbol+"</b></span>";
				My_Balance.Markup = "<span font='15'><b>"+String.Format(CultureInfo.InvariantCulture, "{0:0.########}", balance) + " " + trade_symbol+"</b></span>";
				Price_Header.Markup = "<span font='14'>Price (" + base_symbol + "):</span>";
				Amount_Header.Markup = "<span font='14'>Amount (" + trade_symbol + "):</span>";
				Min_Amount_Header.Markup = "<span font='14'>Minimum Match (" + trade_symbol + "):</span>";
				Total_Header.Markup = "<span font='14'>Total Receive (" + base_symbol + "):</span>";
            }
            this.Show();
        }
		...
		private async void Make_Order(object sender, EventArgs e)
        {
			...
			Gtk.Label order_label = (Gtk.Label)Order_Button.Children[0];
			order_label.Markup = "<span font='17'>Contacting CN...</span>";
