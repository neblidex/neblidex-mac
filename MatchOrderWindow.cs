...
namespace NebliDex_Linux
{
    public partial class MatchOrderWindow : Gtk.Window
    {
                ...
                base(Gtk.WindowType.Toplevel)
        {
			...
			match_label.Markup = "<span font='17'>Match</span>";
            ...
            {
                //Buy Order
				Header.Markup = "<span font='21'><b>Buy Order Details</b></span>";
				Order_Type.Markup = "<span font='15'>Requesting:</span>";
				Order_Amount.Markup = "<span font='15'><b>" + String.Format(CultureInfo.InvariantCulture, "{0:0.########}", ord.amount)+" " + trade_symbol+"</b></span>";
				Order_Min_Amount.Markup = "<span font='15'><b>"+String.Format(CultureInfo.InvariantCulture, "{0:0.########}", min_ord)+" " + trade_symbol+"</b></span>";
				Price.Markup = "<span font='15'><b>"+String.Format(CultureInfo.InvariantCulture, "{0:0.########}", ord.price)+" " + base_symbol+"</b></span>";
                decimal my_balance = App.GetMarketBalance(App.exchange_market, 1); //If they are buying, we are selling

				My_Amount_Header.Markup = "<span font='14'>Amount (" + trade_symbol + "):</span>";
				Total_Cost_Header.Markup = "<span font='14'>Total Receive (" + base_symbol + "):</span>";
				My_Balance.Markup = "<span font='14'><b>"+String.Format(CultureInfo.InvariantCulture, "{0:0.########}", my_balance) + " " + trade_symbol+"</b></span>";

            }
            else
            {
                //Sell Order
				Header.Markup = "<span font='21'><b>Sell Order Details</b></span>";
				Order_Type.Markup = "<span font='15'>Available:</span>";
				Order_Amount.Markup = "<span font='15'><b>" + String.Format(CultureInfo.InvariantCulture, "{0:0.########}", ord.amount)+" " + trade_symbol+"</b></span>";
				Order_Min_Amount.Markup = "<span font='15'><b>"+String.Format(CultureInfo.InvariantCulture, "{0:0.########}", min_ord)+" " + trade_symbol+"</b></span>";
				Price.Markup = "<span font='15'><b>"+String.Format(CultureInfo.InvariantCulture, "{0:0.########}", ord.price)+" " + base_symbol+"</b></span>";
				...
				My_Amount_Header.Markup = "<span font='14'>Amount (" + trade_symbol + "):</span>";
				Total_Cost_Header.Markup = "<span font='14'>Total Cost (" + base_symbol + "):</span>";
				My_Balance.Markup = "<span font='14'><b>"+String.Format(CultureInfo.InvariantCulture, "{0:0.########}", my_balance) + " " + base_symbol+"</b></span>";
            }
        }
		...
		private async void Match_Order(object sender, EventArgs e)
        {
			...
			Gtk.Label match_label = (Gtk.Label)Match_Button.Children[0];
			match_label.Markup = "<span font='17'>Contacting CN...</span>";
